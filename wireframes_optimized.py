...
class WireframeGeneratorOptimized:
    def __init__(self):
        ...
        # Using compatible symbols instead of emojis
        self.symbols = {
            'chart': '📊',
            'user': '👤',
            'robot': '🤖',
    ...
    def generate_home_wireframe(self):
        ...
        for i, investor in enumerate(investors):
            ...
            ax.text(card_x + 9, 43, "USER", ha='center', va='center', fontsize=8)
    ...
    def generate_profile_wireframe(self):
        ...
        ax.text(modal_x + modal_width - 3.5, modal_y + modal_height - 3.5, "X", ha='center', va='center', 
    ...
    def generate_all_wireframes(self, filename="wireframes_agente_investidor_otimizado.pdf"):
...
if __name__ == "__main__":
    generator = WireframeGeneratorOptimized()
